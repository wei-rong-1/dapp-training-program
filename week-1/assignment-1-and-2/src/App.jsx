...
import { Assignment1, Assignment2 } from "./views";
...
function App({}) {
  ...
  return (
    <div className="App">
      <Header>
        <Menu style={{ textAlign: "center", flex: 1, borderBottom: 'none' }} selectedKeys={[location.pathname]} mode="horizontal">
          <Menu.Item key="/">
            <Link to="/">Assignment 1</Link>
          </Menu.Item>
          <Menu.Item key="/assignments/2">
